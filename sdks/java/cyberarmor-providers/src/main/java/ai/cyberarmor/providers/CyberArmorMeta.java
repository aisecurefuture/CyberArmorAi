...
/** Meta wrapper via OpenAI-compatible endpoint. */
public class CyberArmorMeta {
    private static final String DEFAULT_BASE_URL = "https://api.together.xyz/v1";
    private final CyberArmorOpenAI delegate;

    public CyberArmorMeta(CyberArmorClient cyberArmorClient, String apiKey) {
        this.delegate = new CyberArmorOpenAI(cyberArmorClient, apiKey, DEFAULT_BASE_URL);
    }

    public CyberArmorMeta(CyberArmorClient cyberArmorClient, String apiKey, String baseUrl) {
