...
/** xAI wrapper via OpenAI-compatible endpoint. */
public class CyberArmorXAI {
    private static final String DEFAULT_BASE_URL = "https://api.x.ai/v1";
    private final CyberArmorOpenAI delegate;

    public CyberArmorXAI(CyberArmorClient cyberArmorClient, String apiKey) {
        this.delegate = new CyberArmorOpenAI(cyberArmorClient, apiKey, DEFAULT_BASE_URL);
    }

    public CyberArmorXAI(CyberArmorClient cyberArmorClient, String apiKey, String baseUrl) {
