...
/// <summary>
/// Vercel-AI-style adapter that enforces CyberArmor policy around text generation.
/// </summary>
public sealed class CyberArmorVercelAI
{
        ...
        CancellationToken ct = default)
    {
        ...
        var result = await executor(input, ct).ConfigureAwait(false);
        sw.Stop();
