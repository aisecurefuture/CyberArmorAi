...
/// <summary>xAI wrapper via OpenAI-compatible endpoint/gateway.</summary>
public sealed class CyberArmorXAI
{
    private readonly CyberArmorOpenAI _delegate;

    public CyberArmorXAI(CyberArmorClient client, string apiKey, string model = "grok-3")
    {
