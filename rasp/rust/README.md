# CyberArmor Rust RASP

Rust Runtime Application Self-Protection package for inspecting AI-bound traffic, detecting prompt injection, and enforcing DLP-aware policy controls.
...
- Cargo manifest: [Cargo.toml](/Users/patrickkelly/Documents/CyberArmorAi/rasp/rust/Cargo.toml)
- Primary source: [lib.rs](/Users/patrickkelly/Documents/CyberArmorAi/rasp/rust/src/lib.rs)

## Local Verification

```bash
cd /Users/patrickkelly/Documents/CyberArmorAi/rasp/rust
cargo test
```
