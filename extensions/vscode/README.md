...
VS Code extension for monitoring AI assistant activity, applying DLP checks, and enforcing CyberArmor policy controls in the development environment.
...
- Extension id: `cyberarmor-vscode`
- Main entrypoint: `out/extension.js`

## Local Development

```bash
cd /Users/patrickkelly/Documents/CyberArmorAi/extensions/vscode
npm install
npm run compile
```
