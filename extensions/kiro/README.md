# CyberArmor Kiro Extension

Kiro extension for monitoring AI-assisted coding activity, applying DLP checks, and enforcing CyberArmor policy controls inside the editor.
...
- Extension id: `cyberarmor-kiro`
- Main entrypoint: `out/extension.js`

## Local Development

```bash
cd /Users/patrickkelly/Documents/CyberArmorAi/extensions/kiro
npm install
npm run compile
```
